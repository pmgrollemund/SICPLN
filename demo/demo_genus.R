...
source(code_path)
# source("/home/gdremesh/Bureau/new_code/mon_code_fonction.R")
# load("/home/gdremesh/Bureau/new_code/genus2.RData")
...
plot_coef_pln <- coef_genus_barre(genus2_pln_offset$model_par$B[-1,], 
                                  axis_names = c("Genus", "Variables", "Coefficients value", "PLN"), -3, 3)
plot_coef_sicpln <- coef_genus_barre(genus2_sicpln$res_fisher$model_par$B[-1,], axis_names = c("Genus species", "Variables", "Coefficients value", "SICPLN"), -3, 3)
