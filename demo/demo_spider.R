...
spider_sicpln <- SICPLN(formule , data = data_to_PLN, control = control)
print(spider_sicpln$res_fisher$model_par$B)
# , offset_column_name = "FallTwig"
...
combined_density_plot <- plot_combined_density(data$Abundance, spider_pln$fitted,spider_sicpln$fitted,
...
save.image(file.path(output, "Renv.RData"))
>>>>>>> 5be7c3b49da5e96b377232e3d89e3ba6ffc9068a
